 ...
 */
@Entity
@Table(name = "clientes", catalog = "APRENDER", schema = "")
@NamedQueries({
    @NamedQuery(name = "Clientes.findAll", query = "SELECT c FROM Clientes c")
    , @NamedQuery(name = "Clientes.findByCliCod", query = "SELECT c FROM Clientes c WHERE c.cliCod = :cliCod")
    ...
    , @NamedQuery(name = "Clientes.findByCliTel", query = "SELECT c FROM Clientes c WHERE c.cliTel = :cliTel")})
public class Clientes implements Serializable {
    ...
    public Clientes(Integer cliCod) {
        this.cliCod = cliCod;
    }

    public Clientes(Integer cliCod, String cliNome) {
        this.cliCod = cliCod;
    ...
    public String toString() {
        return "View.Clientes[ cliCod=" + cliCod + " ]";
    }
