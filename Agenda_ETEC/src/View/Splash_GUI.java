...
public class Splash_GUI extends javax.swing.JFrame {
        ...
        for (int i=0; i<101; i++){
                    try {
                        ...
                        if(barra.getValue() == 10){
                            ...
                            mensagem.setText("Fazendo contato extraterrestre");
                          
                            sleep(2000);
                                                       
                        
                        }else if (barra.getValue() <=30){
                            mensagem.setText("Carregando o etevaldo");
                          sleep(100);  
                        } else if (barra.getValue() <=99){
                            mensagem.setText("Carregamento quase nos trinques");
                            
                        }else{
                            mensagem.setText("Carregamento completo chuchu, pode aproveitar!.");
    ...
    private void initComponents() {
        ...
        barra.setForeground(new java.awt.Color(31, 198, 86));
        jPanel1.add(barra);
        barra.setBounds(50, 160, 300, 14);
        jPanel1.add(mensagem);
        mensagem.setBounds(50, 210, 310, 60);
